...
import { AlertCircle, User, Shield, Ticket, QrCode } from "lucide-react";
...
const LoginPage = () => {
  ...
  const handleClientLogin = async () => {
    ...
    try {
      const response = await fetch(`http://localhost:8080/api/tickets/${formData.ticketId}/session`);
      ...
      // Store session data for the attendee view
      localStorage.setItem('ticketSession', JSON.stringify({
        ticketId: formData.ticketId,
        ...sessionData,
        loginType: 'client'
      }));

      // Navigate to attendee view
      navigate('/attendee');
  ...
  const handleStaffLogin = async () => {
    ...
    try {
      ...
      // Store staff data for scanner view
            ...
            <div className="space-y-4">
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Accede con tu ID de ticket para ver tu QR de entrada
                  </p>
                </div>
              </button>
              ...
              >
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    Acceso para personal de puertas y zonas
                  </p>
                </div>
              </button>
            </div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Ingresa el ID de tu ticket para acceder
                </p>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  ...
                  disabled={isLoading || !formData.ticketId.trim()}
                  className="flex-1"
                >
